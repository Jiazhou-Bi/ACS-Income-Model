...
This is a general version (compared to the detailed version). The reason of choosing the general version is mentioned in @sec-data above
## Mortgage
...
#| label: fig-figure1
#| warning: false
#| tbl-cap: Dwelling Ownership Details
...
plt.title('Distribution of Mortgage Status', fontsize=14)
...
::: {#tbl-XGBoostCV}
\begin{center}
Table 7: Cross-Validation RMSE for XGBoost Model
\end{center}
